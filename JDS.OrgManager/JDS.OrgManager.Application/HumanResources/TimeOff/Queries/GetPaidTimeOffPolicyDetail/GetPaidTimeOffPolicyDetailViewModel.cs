...
namespace JDS.OrgManager.Application.HumanResources.TimeOff.Queries.GetPaidTimeOffPolicyDetail
{
    public class GetPaidTimeOffPolicyDetailViewModel : IViewModel
    {
